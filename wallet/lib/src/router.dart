...
import 'package:iop_wallet/src/pages/credentials/credentials.dart';
...
import 'package:iop_wallet/src/pages/onboarding/create_wallet.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  ...
  else if (settings.name == routeSetupCreateWallet) {
    page = CreateWallet();
  }
  ...
  else if(settings.name == routeCredentials) {
